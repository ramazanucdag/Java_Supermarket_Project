...
public class Giris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Parola.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Parola, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(77, 77, 77)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel5)
                        .addComponent(Parola, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
      ...
      {
        String Query = "select * from User1.SATICITBL where SATADI='"+Uid.getText()+"' and SATPASS='"+Parola.getText()+"'";
      try{
         ...
         if(Rs.next()){
            ...
            this.dispose();
             ...
             JOptionPane.showMessageDialog(this,"Satıcı Kimliği veya Şifresi Yanlış");
         }
      }catch(SQLException ex) 
      {
          ex.printStackTrace();
           ...
           String Query = "select * from User1.YONETICITBL where YONETICIADI='"+Uid.getText()+"' and YONETICISIFRESI='"+Parola.getText()+"'";
      try{
         Con = DriverManager.getConnection("jdbc:derby://localhost:1527/SuperMarket1","User1","2145");
         St = Con.createStatement();
         Rs = St.executeQuery(Query);
         if(Rs.next()){
            ...
            this.dispose();
             ...
             JOptionPane.showMessageDialog(this,"Yönetici Kimliği veya Şifresi Yanlış");
         }
      }catch(SQLException ex) 
      {
          ex.printStackTrace();
